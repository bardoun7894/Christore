                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="brand_id" name="brand_id" class="form-control select2" style="width: 100%;">
                                        ...
                                        @foreach ($getBrands as $getBrand)
                                            <option value="{{ $getBrand->id }}"
                                                @if (!empty($productData['brand_id']) && $productData['brand_id'] == $getBrand->id) )  selected @endif>{{ $getBrand->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="input-group mb-3">
                                        <input id="description" name="description" type="text" class="form-control"
                                            ...
                                            @if (!empty($productData['description'])) value ="{{ $productData['description'] }}"
                                           @else
                                                 value ="{{ old('description') }}" @endif>
                                    </div>
                                    <label>Product Discount</label>
                                    <div class="input-group mb-3">
                                        <input id="product_discount" name="product_discount" type="text"
...
@endif
                                    ...
                                    <textarea id="meta_keywords" name="meta_keywords" type="text" class="form-control" rows="3"
...
@endif
                        ...
                        value ="{{ old('product_price') }}" @endif>
                                    ...
                                    <input id="product_weight" name="product_weight" type="text" class="form-control"
                                        rows="3" placeholder="Enter Product weight"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="file" name="product_image" class="custom-file-input"
                                                id="product_image"
                                                @if (!empty($productData['main_image'])) value = "{{ $productData['main_image'] }}"
                            @else
                                value = "{{ old('main_image') }}" @endif>
                                        ...
                                        <div class="image_preview " id="image_preview"
                                            ...
                                            <div style="height:80px;">
                                                <img style="width: 150px" class="image_preview_image"
                                                    @if (!empty($productData['main_image'])) src="{{ asset('images/product_image/small/' . $productData['main_image']) }}"
                             @else
                                 src="{{ asset('images/no-image.png') }}" @endif>
